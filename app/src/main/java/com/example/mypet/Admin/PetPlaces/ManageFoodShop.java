...
public class ManageFoodShop extends AppCompatActivity {
    String type;

    Button add_food_shop;
    LinearLayout food_shop_list;

    @Override
    public void onRestart() {
        super.onRestart();
        food_shop_list.removeAllViews();
        getFoodShopslist();
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_manage_food_shop);
        ...
        add_food_shop = findViewById(R.id.add_food_shop);
        food_shop_list = findViewById(R.id.food_shop_list);


        add_food_shop.setOnClickListener(new View.OnClickListener() {
            @Override
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < data.length(); i++) {
                                ShowFoodShopslist(data.getJSONObject(i));
    ...
    private void ShowFoodShopslist(JSONObject data) throws JSONException {
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                showDialog(ManageFoodShop.this, id);
            }
        });

        food_shop_list.addView(view);
                ...
                StringRequest jsonRequest = new StringRequest(
                        ...
                        new Response.Listener<String>() {
                            ...
                            public void onResponse(String response) {
                                ...
                                Toast.makeText(ManageFoodShop.this, "Food Shop deleted successfully", Toast.LENGTH_SHORT).show();
                                dialog.dismiss();
                                finish();
