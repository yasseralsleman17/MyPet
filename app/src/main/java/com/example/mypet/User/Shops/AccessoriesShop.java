...
public class AccessoriesShop extends AppCompatActivity {

    LinearLayout accessories_shop;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_accessories_shop);

        ActionBar actionBar = getSupportActionBar();
        actionBar.hide();


        accessories_shop = findViewById(R.id.accessories_shop);
    ...
    private void getAccessoriesShop() {
        ...
        StringRequest jsonRequest = new StringRequest(
            ...
            protected Map<String, String> getParams() {
                ...
                MyData.put("type", "accessories shops");
