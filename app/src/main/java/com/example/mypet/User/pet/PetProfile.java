...
public class PetProfile extends AppCompatActivity {
    ...
    ImageView imageView;
    TextView pet_name,pet_birth,pet_sex,pet_weight,pet_diseases,pet_MEDICATION;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final String REQUEST_URL = Var.delete_pet;
                ...
                StringRequest jsonRequest = new StringRequest(
                        ...
                        new Response.Listener<String>() {
                            ...
                            public void onResponse(String response) {
                                ...
                                Toast.makeText(PetProfile.this, "pet deleted successfully", Toast.LENGTH_SHORT).show();
                                finish();
        ...
        button_edit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(getApplicationContext(),EditPet.class).putExtra("pet_id",pet_id).putExtra("user_id",user_id));
            }
        });
