...
import com.example.mypet.User.ChatActivity;
...
public class PetResortsShop extends AppCompatActivity {

    LinearLayout pet_resorts_shop;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pet_resorts_shop);

        ActionBar actionBar = getSupportActionBar();
        actionBar.hide();

        pet_resorts_shop=findViewById(R.id.pet_resorts_shop);
    ...
    private void getPetResortsShop() {
        ...
        StringRequest jsonRequest = new StringRequest(
            ...
            protected Map<String, String> getParams() {
                ...
                MyData.put("type", "pet restores shops");
